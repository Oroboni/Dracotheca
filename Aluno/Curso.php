...
<head>
    ...
    if (isset($_SESSION['curso'])) {
        $query = "SELECT * FROM livro WHERE CURSO_LIV = ? LIMIT 5";
    ...
    <main class="content">
        ...
        <div class="books-container">
            <div class="section popular">
                ...
                <div class="books-row">
                <?php foreach ($Curso_livros as $Curso_livro): ?>
                        <a href="./detalhesLivro.php?id=<?php echo $Curso_livro['TOMBO_LIV']; ?>" class="book">
                            <img id="imgPreview" src="<?php echo !empty($Curso_livro['FOTO_LIV']) && $Curso_livro['FOTO_LIV'] != '../src/img/books/capa.png' && file_exists('../src/img/books/' . $Curso_livro['FOTO_LIV']) ? '../src/img/books/' . $Curso_livro['FOTO_LIV'] : '../src/img/books/capa.png'; ?>" class="rounded img-fluid" alt="img-perfil">
                            <p><?php echo $Curso_livro['TITULO_LIV']; ?></p>
                        </a>
                    <?php endforeach; ?>
                </div>
            </div>
