...
<head>
    ...
    if($emprestimoAtual != null){    
        ...
        $dataDevolucao = new DateTime($emprestimoAtual['DT_DEVOLUCAO']);
        $intervalo = $dataAtual->diff($dataDevolucao)->days;
        
        $dataLimite = (clone $dataDevolucao)->add(new DateInterval('P7D'));
        $dataAtual = new DateTime();
    }
    ?>
</head>
                        ...
                        <div class="row">
                            <div class="col btns">
                                ...
                                <?php elseif ($emprestimoAtual): ?>
                                    ...
                                    <?php if ($dataAtual > $dataLimite): ?>
                                        <a href="./PHP/renovar.php?id=<?php echo $livro['TOMBO_LIV']; ?>" class="btn dispo disponivel">
                                            Renovar <img src="./src/img/icons/emoji-happy.png" alt="Disponível" class="btn-icon">
                                        </a>
                                    <?php endif; ?>
                                <?php elseif ($jaNaFila): ?>
