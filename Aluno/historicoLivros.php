...
<head>
    ...
    $query = "SELECT DISTINCT l.TOMBO_LIV, l.TITULO_LIV AS titulo, l.FOTO_LIV, e.DT_EMPREST AS dataEmprestimo, e.DT_DEVOLUCAO AS prazoEntrega, d.DT_DEVOL AS dataDevolucao,
        CASE 
            WHEN e.DEVOLVIDO = 's' THEN 'Devolvido'
