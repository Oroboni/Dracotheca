...
try {
    $queryEmprestimos = "SELECT e.ID_EMPREST, a.NOME_ALUNO, a.RA_ALUNO, l.TITULO_LIV, e.DT_EMPREST, e.DT_DEVOLUCAO, e.FK_TOMBO_LIV, e.FK_ID_ALUNO, l.FOTO_LIV FROM emprestimos e JOIN livro l ON e.FK_TOMBO_LIV = l.TOMBO_LIV JOIN aluno a ON e.FK_ID_ALUNO  = a.ID_ALUNO";
...
<body>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const dataAluno = document.querySelector('.data-aluno');
