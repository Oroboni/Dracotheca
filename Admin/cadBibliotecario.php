<!-- 
    ...
    *   @version 1.0    
    *   @file cadBibliotecario.php
    *   @description Página PHP para cadastro de bibliotecários com um formulário de entrada de dados.
    *   O formulário HTML utiliza o método POST para enviar os dados ao arquivo PHP (envia_b.php), que processa as informações e as insere no banco.
    */
-->
