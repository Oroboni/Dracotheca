<!-- 
    ...
    *   Aqui, ela fica disponível para o acesso do administrador para com as telas. Ele tem acesso livre a todo o sistema.
    */
-->
...
if (!isset($_SESSION['login_adm']) || $_SESSION['login_adm'] !== true) {
    echo "<script>
        ...
        window.location.href = 'http://dracotheca.great-site.net/index.php';
    </script>";
    exit();
}
?>
    ...
    <nav id="sidebar">
        <div id="sidebar_content">
            ...
            <ul id="side_itens">
                ...
                <li class="side-item">
                    <a href="./bibliotecarios.php">
                        <img src="./src/img/icons/glass.png" alt="ger-bibliot">
                        Gerenciar bibliotecário
                    </a>
                </li>
                <li class="side-item">
                    <a href="./livros.php">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', cores, foto);
</script>