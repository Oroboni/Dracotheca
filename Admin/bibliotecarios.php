                ...
                <div class="tabela">
                    <div class="cad">
                        <a href="./cadBibliotecario.php" class="btn cadastrar">
                            Cadastrar <img src="./src/img/icons/add-circle.png" alt="Cadastrar" class="btn-icon">
                        </a>
                    </div>
                                    ...
                                    <div class="modal fade" id="excluirLivro<?php echo $biblio['ID_BIBLIOT']; ?>"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-custom">
                                            <div class="modal-content">
                                                ...
                                                <form action="./php/deleta_b.php" method="POST">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        deleteButtons.forEach(button => {
            button.addEventListener('click', function() {
                const biblioId = button.getAttribute('data-id');
                console.log(`Livro selecionado para exclusão: ${biblioId}`);
            });
        });
    });
</script>