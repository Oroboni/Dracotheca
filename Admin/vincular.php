                ...
                fetch(`./PHP/fetchLivro.php?tombo=${tombo}`)
                    ...
                    .then(data => {
                        if (data.success) {
                            ...
                            document.getElementById("capa").src = data.foto || '../src/img/books/capa.png';
                        } else {
                            document.getElementById("titulo").value = '';
                            document.getElementById("edicao").value = '';
                            document.getElementById("capa").src = '../src/img/books/capa.png';
                                        ...
                                        <div class="col-md-8">
                                            <div class="row g-4">
                                                <div class="col top">
                                                    ...
                                                    <input id="ra" name="idAluno" type="number" class="form-control" placeholder="Digite o RA" onchange="fetchAluno()" min="0">
                                                </div>
                                            </div>
                                            <div class="row g-4">
                                                <div class="col">
                                        ...
                                        <div class="col-md-8">
                                            <div class="row g-4">
                                                <div class="col top">
                                                    ...
                                                    <input id="tombo" name="idLivro" type="number" class="form-control" placeholder="Digite o tombo do livro" onchange="fetchLivro()" min="0">
                                                </div>
                                            </div>
                                            <div class="row g-4">
                                                <div class="col">
