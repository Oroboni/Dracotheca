<!-- 
    ...
    *   @description Tela de configurações do administrador 
    *   Arquivo responsável por disponibilizar a tela de configurações para o administrador, incluindo informações pessoais, permissões e funcionalidades.
    */
-->
        ...
        <div class="modal-content">
          ...
          <form action="">
            <div class="form-group">
              ...
              <input type="password" class="form-control inputModal" placeholder="Digite sua senha atual" required>

            </div>
            <div class="form-group">
              <label for="senhaNova">Nova senha</label>
              <input type="password" class="form-control inputModal" placeholder="Digite a nova senha" required>
            </div>
            <div class="form-group">
              <label for="senhaNovaC">Confirmar nova senha</label>
              <input type="password" class="form-control inputModal" placeholder="Digite a nova senha novamente" required>
