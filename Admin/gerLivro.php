                            ...
                            <div class="row g-3 seg">
                                <div class="col">
                                    ...
                                    <select id="dispo" name="disponivel" disabled class="form-select">
                                        <option selected disabled value="">Selecione</option>
                                        <option <?php echo ($livro['DISPON_LIV'] == 'd') ? 'selected' : ''; ?>>
                                            Disponível</option>
                                        <option <?php echo ($livro['DISPON_LIV'] == 'i') ? 'selected' : ''; ?>>
                                            Indisponível</option>
                                    </select>
                                </div>
                                <div class="col">
                                    ...
                                    <select id="status" name="status" class="form-select disabled" disabled>
                                        ...
                                        <option <?php echo ($livro['STATUS_LIV'] == 'Circulante') ? 'selected' : ''; ?>>
                                            Circulante</option>
                                        <option <?php echo ($livro['STATUS_LIV'] == 'Consulta Local') ? 'selected' : ''; ?>> Consulta Local</option>
                                        <option <?php echo ($livro['STATUS_LIV'] == 'Indisponível') ? 'selected' : ''; ?>> Indisponível</option>
                                    </select>
                                </div>
                            </div>
