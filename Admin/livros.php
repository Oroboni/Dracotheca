...
// Handle book deletion if POST request is received
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['id'])) {
    ...
    if ($emprestado > 0) {
        echo "<script>alert('Erro: Não é possível apagar um livro que está emprestado!'); window.location.href='livros.php';</script>";
        exit();
    }

    // Get book image to delete
