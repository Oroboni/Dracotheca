                ...
                <div class="tabela">
                    <div class="cad">
                        <a href="./cadAluno.php" class="btn cadastrar">
                            <img src="./src/img/icons/user-edit.png" alt="Cadastrar" class="btn-icon">
                            ‎ Cadastrar
                        </a>
                    </div>
                                        ...
                                        <td>
                                            <div class="btns">
                                                <a href="./gerAluno.php?id=<?php echo $aluno['ID_ALUNO']; ?>"
                                                    ...
                                                    <img src="./src/img/icons/eye.png" alt="Visualizar" class="btn-icon"> 
                                                    ‎ Visualizar
                                                </a>
                                                <a href="./editAluno.php?id=<?php echo $aluno['ID_ALUNO']; ?>"
                                                    class="btn editar">
                                                    <img src="./src/img/icons/edit-2.png" alt="Editar" class="btn-icon"> 
                                                    ‎ Editar
                                                </a>
                                                <button type="button" class="btn excluir" data-bs-toggle="modal"
                                                    data-bs-target="#excluirAluno" data-id="<?php echo $aluno['ID_ALUNO']; ?>">
                                                    <img src="./src/img/icons/trash.png" alt="Excluir" class="btn-icon"> 
                                                    ‎  Excluir
                                                </button>
                                            </div>
                                        </td>
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-custom">
                        <div class="modal-content">
                            <div class="pergunta text-center">
                                <!-- Pergunta de confirmação para excluir aluno -->
                            ...
                            <form method="POST">
                                <div class="btns-pergunta d-flex justify-content-center align-items-center">
                                    ...
                                    <button type="submit" class="btn btn-modal-excluir excluir mx-2" data-id="<?php echo $aluno['ID_ALUNO']; ?>">
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            deleteButtons.forEach(button => {
                button.addEventListener('click', function () {
                    ...
                    alunoIdInput.value = alunoId; // Define o ID do aluno no campo oculto
                });
            });
        });
    </script>