    ...
    <main class="content">
        ...
        <div class="books-container">
            <div class="section popular">
                ...
                <div class="books-row">
                    <?php $i = 0; foreach ($livrosPopulares as $livrosPopulare): ?>
                        <a href="./gerLivro.php?id=<?php echo $livrosPopulare['TOMBO_LIV']; ?>" class="book">
                            ...
                            <p><?php echo $livrosPopulare['TITULO_LIV']; ?></p>
                        </a>
            ...
            <div class="section recomt">
                ...
                <div class="books-row">
                    <?php $i = 0; foreach ($livros as $livro): ?>
...
<script>
    ...
    function renderBooks(livros) {
        ...
        livros.forEach(livro => {
            ...
            bookLink.href = `./gerLivro.php?id=${livro.TOMBO_LIV}`;
