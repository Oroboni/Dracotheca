                ...
                <form method="POST" enctype="multipart/form-data"
                    ...
                    <div class="row align-items-start">
                        <div class="col-md-9">
                            ...
                            <div class="row g-3 seg">
                                ...
                                <div class="col">
                                    ...
                                    <select id="tipoAqu" name="tipoAqu" class="form-select" required>
                                        ...
                                        <option <?php echo ($livro['TPAQUISICAO_LIV'] == 'C') ? 'selected' : ''; ?>> Compra</option>
                                        <option <?php echo ($livro['TPAQUISICAO_LIV'] == 'M') ? 'selected' : ''; ?>> Comodato</option>
                                        <option <?php echo ($livro['TPAQUISICAO_LIV'] == 'P') ? 'selected' : ''; ?>> Permuta</option>
                                        <option <?php echo ($livro['TPAQUISICAO_LIV'] == 'D') ? 'selected' : ''; ?>> Doação</option>
                                        <option <?php echo ($livro['TPAQUISICAO_LIV'] == 'X') ? 'selected' : ''; ?>> Desconhecida</option>
                                        <option <?php echo ($livro['TPAQUISICAO_LIV'] == 'O') ? 'selected' : ''; ?>>Outra</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row g-3 seg">
                                <div class="col">
                                    ...
                                    <select id="dispo" name="disponivel" required class="form-select">
                                        <option selected disabled value="">Selecione</option>
                                        <option <?php echo ($livro['DISPON_LIV'] == 'd' || $livro['DISPON_LIV'] == 'D') ? 'selected' : ''; ?>>
                                            Disponível</option>
                                        <option <?php echo ($livro['DISPON_LIV'] == 'i' || $livro['DISPON_LIV'] == 'I') ? 'selected' : ''; ?>>
                                            Indisponível</option>
                                    </select>
                                </div>
                                <div class="col">
                                    ...
                                    <select id="status" name="status" class="form-select disabled" required>
                                        <option selected disabled value="">Selecione</option>
                                        <option <?php echo ($livro['STATUS_LIV'] == 'Circulante') ? 'selected' : ''; ?>>
                                            Circulante</option>
                                        <option <?php echo ($livro['STATUS_LIV'] == 'Consulta Local') ? 'selected' : ''; ?>>
                                            Consulta Local</option>
                                        <option <?php echo ($livro['STATUS_LIV'] == 'Indisponível') ? 'selected' : ''; ?>> 
                                            Indisponível</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="mb-3 segundos">
                                ...
                                <input id="comp" name="complemento" type="text" class="form-control"
                    ...
                    <div class="btns">
                        <button type="button" class="btn cancelar" onclick="history.back()">
                            <img src="./src/img/icons/slash.png" alt="Cancelar" class="btn-icon"> Cancelar
                        </button>
                        <button type="submit" class="btn salvar">
                            <img src="./src/img/icons/save-2.png" alt="Salvar" class="btn-icon"> Salvar
                        </button>
                    </div>
                </form>
            </div>
