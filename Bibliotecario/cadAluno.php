                        ...
                        <div class="col-md-9">
                            ...
                            <div class="row g-3">
                                <div class="col">
                                    ...
                                    <input type="number" id="cpf" min="0" name="cpf" class="form-control" placeholder="000.000.000-00" aria-label="CPF" required>
                                </div>
                                <div class="col">
                                    <label for="ra" class="form-label">RA</label>
                                    <input type="number" id="ra" name="ra" class="form-control" placeholder="Digite seu RA" aria-label="RA" min="0" required>
                                </div>
                            </div>
